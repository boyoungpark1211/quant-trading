...
def run_backtest(
    ...
    """Positions are applied with a 1-bar lag (you can only act on a signal after it's known),
    and every position *change* pays `fee_rate` once, approximating round-trip exchange fees.
    """
    price = df["close"]
